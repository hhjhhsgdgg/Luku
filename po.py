...
bot = telebot.TeleBot('7838136725:AAFpoE7ELqfMjBYhTLU3-lxsxeTaYVwvpMI')
...
def show_main_buttons(message):
    ...
    bot.send_message(message.chat.id, "🔹 WELCOME TO S4 DDOS BOT 🔹", reply_markup=markup)
...
def handle_buy_coins(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "💰 𝗗𝗠 𝗧𝗢 𝗕𝗨𝗬 𝗖𝗢𝗜𝗡𝗦 @S4_LUCHI")
